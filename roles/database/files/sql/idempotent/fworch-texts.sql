...
INSERT INTO txt VALUES ('importPathAnalysisDataPath', 'German', 'Pfad und Name von Pfadanalyse-TSQ-JSON (ohne Endung)');
INSERT INTO txt VALUES ('importPathAnalysisDataPath', 'English', 'Path and Name of path-analysis TSQ JSON import (without ending)');
INSERT INTO txt VALUES ('importPathAnalysisDataSleepTime','German','Import Pfadanalyse-TSQ-Intervall (in Stunden)');
INSERT INTO txt VALUES ('importPathAnalysisDataSleepTime','English','Import path-analysis TSQ sleep time (in hours)');
INSERT INTO txt VALUES ('importPathAnalysisDataStartAt','German', 'Import Pfadanalyse-TSQ-Start');
INSERT INTO txt VALUES ('importPathAnalysisDataStartAt','English','Import path-analysis TSQ start at');
INSERT INTO txt VALUES ('import_path_analysis_data','German','Import Pfadanalyse-Daten');
INSERT INTO txt VALUES ('import_path_analysis_data','English','Import path-analysis data');
INSERT INTO txt VALUES ('pathAnalysisMode','German','Pfadanalyse-Modus');
INSERT INTO txt VALUES ('pathAnalysisMode','English','Path analysis mode');
INSERT INTO txt VALUES ('pathAnalysisMode_GatewayRoutingTable','German','Gateway-Routingtabelle');
INSERT INTO txt VALUES ('pathAnalysisMode_GatewayRoutingTable','English','Gateway routing table');
INSERT INTO txt VALUES ('pathAnalysisMode_StaticImport','German','Statischer Import');
INSERT INTO txt VALUES ('pathAnalysisMode_StaticImport','English','Static import');
INSERT INTO txt VALUES ('H5680','German','Pfadtabellen werden als konvertierte TSQ-JSON-Dateien importiert. Die Dateien muessen unterhalb des Customizing-Verzeichnisses liegen und koennen optional durch ein gleichnamiges Python-Skript aus einer CSV-Datei erzeugt werden.');
INSERT INTO txt VALUES ('H5680','English','Path tables are imported as converted TSQ JSON files. The files must be located below the customization directory and can optionally be generated from CSV by a Python script with the same base name.');
INSERT INTO txt VALUES ('H5681','German','Das Importintervall 0 deaktiviert die automatische Ausfuehrung; der Scheduler-Job bleibt fuer manuelle Ausfuehrung verfuegbar.');
INSERT INTO txt VALUES ('H5681','English','Import interval 0 disables automatic execution; the scheduler job remains available for manual execution.');
INSERT INTO txt VALUES ('H5682','German','Beim Import wird die Pfadtabelle validiert. Bei Topologiefehlern, unbekannten Netzen oder fehlendem Gateway-Mapping wird die Verarbeitung verweigert.');
INSERT INTO txt VALUES ('H5682','English','During import the path table is validated. Processing is rejected for topology errors, unknown networks, or missing gateway mappings.');
INSERT INTO txt VALUES ('H5683','German','Der Pfadanalyse-Modus steuert, ob FWO die statisch importierte Pfadtabelle oder die Gateway-Routingtabelle verwendet.');
INSERT INTO txt VALUES ('H5683','English','The path-analysis mode controls whether FWO uses the statically imported path table or the gateway routing table.');
INSERT INTO txt VALUES ('H5684','German','Das JSON-Importformat enthaelt source_name und entries mit version, zone, network, root_path und internet_path. Network verwendet CIDR-Notation wie 1.2.3.0/24; der Internet-Eintrag verwendet ! RFC1918.');
INSERT INTO txt VALUES ('H5684','English','The JSON import format contains source_name and entries with version, zone, network, root_path, and internet_path. Network uses CIDR notation such as 1.2.3.0/24; the internet entry uses ! RFC1918.');
