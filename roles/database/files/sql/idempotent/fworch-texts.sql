...
INSERT INTO txt VALUES ('trusted_jwt_issuers',   'German',   'Vertrauensw\u00fcrdige JWT-Issuer');
INSERT INTO txt VALUES ('trusted_jwt_issuers',   'English',  'Trusted JWT issuers');
INSERT INTO txt VALUES ('jwt_issuer_hint',       'German',   'Pflegen Sie zus\u00e4tzliche JWT-Issuer, die FWO akzeptieren soll. Der interne Hasura-Issuer bleibt immer aktiv.');
INSERT INTO txt VALUES ('jwt_issuer_hint',       'English',  'Maintain additional JWT issuers that FWO should trust. The internal Hasura issuer always stays active.');
INSERT INTO txt VALUES ('issuer',                'German',   'Issuer');
INSERT INTO txt VALUES ('issuer',                'English',  'Issuer');
INSERT INTO txt VALUES ('add_issuer',            'German',   'Issuer hinzuf\u00fcgen');
INSERT INTO txt VALUES ('add_issuer',            'English',  'Add issuer');
INSERT INTO txt VALUES ('jwt_issuer_placeholder','German',   'z.B. https://example-issuer');
INSERT INTO txt VALUES ('jwt_issuer_placeholder','English',  'e.g. https://example-issuer');
INSERT INTO txt VALUES ('jwt_issuer_publickey_placeholder','German',   'Public Key im PEM-Format f\u00fcr diesen Issuer einf\u00fcgen.');
INSERT INTO txt VALUES ('jwt_issuer_publickey_placeholder','English',  'Insert the public key for this issuer (PEM format).');
INSERT INTO txt VALUES ('default_issuer',        'German',   'System-Issuer');
INSERT INTO txt VALUES ('default_issuer',        'English',  'Built-in issuer');
INSERT INTO txt VALUES ('jwt_issuer_load_error', 'German',   'JWT-Issuer konnten nicht geladen werden.');
INSERT INTO txt VALUES ('jwt_issuer_load_error', 'English',  'Trusted JWT issuers could not be loaded.');
INSERT INTO txt VALUES ('jwt_issuer_saved',      'German',   'JWT-Issuer wurden aktualisiert.');
INSERT INTO txt VALUES ('jwt_issuer_saved',      'English',  'Trusted JWT issuers updated.');
INSERT INTO txt VALUES ('jwt_issuer_save_error', 'German',   'JWT-Issuer konnten nicht gespeichert werden.');
INSERT INTO txt VALUES ('jwt_issuer_save_error', 'English',  'Trusted JWT issuers could not be saved.');
